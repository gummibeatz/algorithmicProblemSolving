...
public class Nails 
{
	...
	public static void main(String[] args) throws IOException
	{
		...
		for(int i=0; i<N; i++)
		{
			...
			double rubberlength = Integer.parseInt(st.nextToken());
			int nails = Integer.parseInt(st.nextToken());
			...
			chullp = chull(points);
			double ans = perimeter(chullp);
			if(ans<rubberlength) sb.append(String.format("%.5f",rubberlength));
			else sb.append(String.format("%.5f",ans));
			sb.append("\n");
		}
		System.out.print(sb);
	}
